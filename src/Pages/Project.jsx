...
const projects = [
  ...
  },
  {
    ...
    description:
      "End-to-end data protection and privacy compliance solutions for organizations handling sensitive information.",
...
export default function Projects({ preview = false }) {
  ...
  return (
    <div className="pt-16 pb-16 bg-slate-100 w-full">
        ...
        <section className="w-full pt-12 pb-16">
          <div className="max-w-6xl mx-auto px-6 text-center">
            ...
            <p className="text-lg text-slate-600 max-w-4xl mx-auto">
              Explore our portfolio of successful cybersecurity implementations and innovative security solutions for various industries.
            </p>
          </div>
        </section>
      )}
      ...
      {!preview && (
        <section className="w-full py-12 bg-[#0b2a5b] mt-16">
          <div className="max-w-6xl mx-auto px-6 text-center text-white">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              <div>
                ...
                <div className="mt-2 text-sm">Projects Completed</div>
              </div>
              <div>
                <div className="text-4xl font-extrabold">98%</div>
                <div className="mt-2 text-sm">Client Satisfaction</div>
              </div>
              <div>
                <div className="text-4xl font-extrabold">24/7</div>
                <div className="mt-2 text-sm">Support Available</div>
              </div>
              <div>
                <div className="text-4xl font-extrabold">50+</div>
                <div className="mt-2 text-sm">Industries Served</div>
              </div>
            </div>
          </div>
        </section>
